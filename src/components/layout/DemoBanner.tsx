      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <p className="truncate text-xs text-muted-foreground">
            <span className="hidden md:inline">Anda sedang berada dalam <strong>Simulasi Operasional NexaMOS CRM</strong>. Data di-reset otomatis setiap Minggu 21:00 WIB.</span>
            <span className="md:hidden">Mode Demo Aktif — Reset berkala Sun 21:00 WIB.</span>
          </p>
        </div>
